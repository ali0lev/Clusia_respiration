#### This is a script to analyse the citrate assays from tissue collected in ORNL in 2016.
...
setwd("D:/illinois.2/For_PhD/respiration paper/copied_from_laptop/copied_from_laptop/ORNL work")

citrate_2016 <- read.csv("citrate_assay_ORNL_2016.csv", skip =2)

setwd("D:/illinois.2/For_PhD/respiration paper/copied_from_laptop/copied_from_laptop/from laptop desktop")
...
# This gives the change in OD from the start to the end of the reaction during the assay


citrate_2016$citrate <- (citrate_2016$D_OD - -0.005125219)/-0.003970438

# This calculation gives the concentration of citrate in the cuvette during the assay

# First I need to work out how much citrate was in the (diluted) buffered solution. As I used 30uL which came from 200uL of (diluted) buffer solution, 
# I can work out the amount of nMoles in the 200uL by doing citrate*6.66666666 (as 30*6.666666 = 200)

citrate_2016$citrate <- citrate_2016$citrate * 6.6666 

# This gives the nanomoles in the 20 uL allequot that was added to the cuvette
# I then need to multiply this by 20 to calculate how much was in the 400 uL allquot

citrate_2016$citrate <- citrate_2016$citrate * 20

# Finally, I need to multiply this by 3.75, to calculate how much citrate was in the 1500 uL sample (i.e. how much was in the leaf tissue that went into the epindorf)
citrate_2016$citrate <- citrate_2016$citrate * 3.75

# Finally, I need to divide by 1000, to convert the value from nanomoles to micromoles

citrate_2016$citrate <- citrate_2016$citrate / 1000
...
# This is the fresh to dry weight ratio, for both well-watered and drought treated leaves, at the end of the experiment. 
...
citrate_2016_agg$citrate_area[citrate_2016_agg$species == 'C. pratensis' & 
                                citrate_2016_agg$time == '6am' & 
                                citrate_2016_agg$treatment == 'Drought'
                                ] - 
citrate_2016_agg$citrate_area[citrate_2016_agg$species == 'C. pratensis' & 
                                  citrate_2016_agg$time == '6pm' & 
                                  citrate_2016_agg$treatment == 'Drought'
                                ]
...
well_watered_pratensis_area <- t.test(citrate_2016$citrate_area[citrate_2016$time == '6am' & citrate_2016$treatment == 'well-watered' & citrate_2016$species == 'C. pratensis'],
                                    citrate_2016$citrate_area[citrate_2016$time == '6pm' & citrate_2016$treatment == 'well-watered' & citrate_2016$species == 'C. pratensis'],
                                    paired = FALSE, alternative = 'greater' )


drought_pratensis_area <- t.test(citrate_2016$citrate_area[citrate_2016$time == '6am' & citrate_2016$treatment == 'drought' & citrate_2016$species == 'C. pratensis'],
                               citrate_2016$citrate_area[citrate_2016$time == '6pm' & citrate_2016$treatment == 'drought' & citrate_2016$species == 'C. pratensis'],
                               paired = FALSE, alternative = 'greater' )



well_watered_tocuchensis_area <- t.test(citrate_2016$citrate_area[citrate_2016$time == '6am' & citrate_2016$treatment == 'well-watered' & citrate_2016$species == 'C. tocuchensis'],
                                      citrate_2016$citrate_area[citrate_2016$time == '6pm' & citrate_2016$treatment == 'well-watered' & citrate_2016$species == 'C. tocuchensis'],
                                      paired = FALSE, alternative = 'greater' )


drought_tocuchensis_area <- t.test(citrate_2016$citrate_area[citrate_2016$time == '6am' & citrate_2016$treatment == 'drought' & citrate_2016$species == 'C. tocuchensis'],
                                 citrate_2016$citrate_area[citrate_2016$time == '6pm' & citrate_2016$treatment == 'drought' & citrate_2016$species == 'C. tocuchensis'],
                                 paired = FALSE, alternative = 'greater' )
